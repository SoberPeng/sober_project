...
//  method success.
#ifndef EVENTSERVICES_BASE_SHARED_PTR_H__
#define EVENTSERVICES_BASE_SHARED_PTR_H__

#include <algorithm>      // std::swap
#include <cstddef>        // for std::ptrdiff_t
#include <stdlib.h>       // for free() decl

#include "eventservice/base/common.h"  // for ASSERT
...
#endif  // #ifndef EVENTSERVICES_BASE_SHARED_PTR_H__
